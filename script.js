    ...
    constructor() {
        ...
        this.i18n = {
            zh: {
                ...
                supportedFormats: '支援 JPG、PNG、GIF，本工具可透過伺服器轉換 HEIC/HEIF',
                convertingHeic: '正在轉換 HEIC/HEIF，請稍候...',
                loadingImage: '正在載入圖片...',
                uploadFailed: '圖片載入失敗，請稍後再試。',
                invalidImageFile: '這不是可匯入的圖片檔案。',
                apiNotConfigured: '目前未設定 HEIC 轉檔 API 位址。',
                ...
                color: '顏色',
                fill: '填滿',
                shapeInstruction: '在畫布上拖曳以繪製',
                polygonInstruction: '點擊畫布新增頂點，雙擊或按 Enter 完成',
                ...
                enterText: '輸入文字...',
                textSize: '字體大小',
                clickCanvasToAddText: '點擊畫布以新增文字',
                resizeTitle: '調整尺寸',
                widthPx: '寬度 (px)',
                heightPx: '高度 (px)',
                maintainRatio: '維持比例',
                ...
                flipHorizontal: '水平翻轉',
                flipVertical: '垂直翻轉',
                cropInstruction: '在畫布上拖曳選取裁切區域，按 Enter 確認或 Escape 取消',
                uploadImage: '上傳圖片',
                filterAdjust: '濾鏡調整',
                presetFilters: '預設濾鏡',
